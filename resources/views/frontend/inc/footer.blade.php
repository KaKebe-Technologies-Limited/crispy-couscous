<section class="bg-white off border-top mt-auto mobileview">
    ...
    <div class="container mobileView">
        <div class="row">
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4 mobileView" >
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 bg-black text-light mobileView">
    <div class="container">
